...
## Project Overview
This project demonstrates a **Natural Language Processing (NLP)-based Billing System** using Python. The system allows users to input product details (name, quantity, price) in a natural language format, and it automatically generates a structured, formatted bill.
